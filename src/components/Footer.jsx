    ...
    return (
        <footer className="mt-10 bg-gradient-to-r bg-[#27AE60]   py-10 px-10 font-sans tracking-wide">
            <div className="max-w-2xl mx-auto text-center">
                <h2 className="text-4xl font-semibold text-white">Seasoned. Nimble. Remote.</h2>
            ...
            <div className=" max-md:flex-col gap-4">
                <p className="text-sm text-center text-gray-300">Copyright © 2023. All rights reserved</p>

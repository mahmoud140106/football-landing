...
export default function Footer() {
    return (
        <footer className="mt-10 bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide">
            <div className="max-w-2xl mx-auto text-center">
                <a href='javascript:void(0)' className="inline-block"><img src="https://readymadeui.com/readymadeui-light.svg" alt="logo"
                    className='w-44' /></a>
                <p className="text-sm mt-8 text-gray-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
                    mi eu pulvinar cursus, sem elit interdum mauris dipiscing elit. Aenean gravida,
                    mi eu pulvinar cursus. <a href='javascript:void(0)' className="text-sm font-semibold text-blue-500">Read
                        more...</a></p>
            ...
            <div className="flex max-md:flex-col gap-4">
                <ul className="flex flex-wrap gap-4">
                    <li className="text-sm">
                        <a href='javascript:void(0)' className='text-gray-300 font-semibold hover:underline'>Terms of Service</a>
                    </li>
                    <li className="text-sm">
                        <a href='javascript:void(0)' className='text-gray-300 font-semibold hover:underline'>Privacy Policy</a>
                    </li>
                    <li className="text-sm">
                        <a href='javascript:void(0)' className='text-gray-300 font-semibold hover:underline'>Security</a>
                    </li>
                </ul>

...
const NotificationCard = ({ onDismiss,onAllow }) => {
  return (
    <motion.div
      ...
      className="bg-white shadow-lg rounded-2xl p-4 w-min text-center flex flex-col items-end justify-between min-h-[11rem]"
    >
      <div className="flex justify-between items-center gap-2">
        ...
        <div className="flex flex-col justify-start items-start ">
          <p className="text-green-600 font-semibold min-w-max">
            Click to allow notification subscription
          </p>
          <p className="text-slate-600 text-sm min-w-max ">
